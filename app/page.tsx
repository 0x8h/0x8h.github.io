  ...
  return (
    <div>
      ...
      {value && value !== "Snowfall" && (
        <ParticlesMemo options={particlesconf[value as keyof ParticleConfig]} className="fixed top-0 left-0 w-full h-full z-0" />
      )}
          ...
          (
            ...
            >
              ...
              <div className="flex flex-col relative border-t overflow-hidden items-center text-center ">
                ...
                <Link href={"https://github.com/0x8h/0x8h.github.io"}>
